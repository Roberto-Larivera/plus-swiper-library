...
<template>
  <div id="FourteenthTry" class="container p-5">
    <div class="row">
      <div class="col text-center">
        <h2>
          FourteenthTry Carousel - Css Mode
        </h2>
      </div>
    </div>
    <div class="row">
      <div class="col">
        <!-- :cssMode="true" in questo  serve solo per la morbidezza nel fare la translate *** ma rimuove la possibilità di muoversi con il click-->
        <swiper 
          class="mySwiper" 
          :cssMode="true"
          :navigation="true"
